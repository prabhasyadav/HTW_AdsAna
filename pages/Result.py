...
if 'dosage_lst' not in st.session_state.keys():
    ...
    with iast_res:
        ...
        calc_df = pd.DataFrame({'Dosage (mg.C/L)':dosage_lst, 'Exp Conc (mg.C/L)':c_exp_lst, 'Calc Conc (mg.C/L)':c_calc, 'Exp Adsorption (mg.C/g)':q_exp_lst, 'Calc Adsorption (mg.C/g)':q_calc})
